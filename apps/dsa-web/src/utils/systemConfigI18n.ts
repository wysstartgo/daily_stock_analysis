...
const fieldTitleMap: Record<string, string> = {
  ...
  LOG_LEVEL: '日志级别',
  WEBUI_PORT: 'WebUI 端口',
  DESKTOP_AUTO_ANALYZE_STOCK_LIST_ON_STARTUP: '桌面端启动自动分析股票池',
...
const fieldDescriptionMap: Record<string, string> = {
  ...
  DESKTOP_AUTO_ANALYZE_STOCK_LIST_ON_STARTUP: '仅桌面端生效。启用后，应用启动并进入首页时会自动按 STOCK_LIST 顺序触发一次分析；关闭后需手动发起分析。',
