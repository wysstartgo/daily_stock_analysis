...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "DESKTOP_AUTO_ANALYZE_STOCK_LIST_ON_STARTUP": {
        "title": "Desktop Auto Analyze Watchlist On Startup",
        "description": "Desktop-only. Automatically analyze the configured STOCK_LIST when entering the home page after app startup.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
